    ...
    render() {
        ...
        <div className="Hero">
            <div className="HeroGroup">
                ...
                <div className="Logos">
                    <a href="https://www.linkedin.com/in/mrabdullahsahin/" target="blank"><img src={require('../../images/linkedin.png')} alt="Abdullah Sahin Linkedin" width="50" /></a>
                    <a href="https://github.com/mrabdullahsahin" target="blank"><img src={require('../../images/github.png')} alt="Abdullah Sahin Github" width="50" /></a>
                    <a href="https://twitter.com/mrabdullahsahin" target="blank"><img src={require('../../images/twitter.png')} alt="Abdullah Sahin Twitter" width="50" /></a>
                    <a href="https://www.instagram.com/mrabdullahsahin/" target="blank"><img src={require('../../images/instagram.png')} alt="Abdullah Sahin Instagram" width="50" /></a>
                </div>
